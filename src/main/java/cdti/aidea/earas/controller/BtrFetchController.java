...
public class BtrFetchController {
    ...
    @Autowired
    private BtrFetchService btrFetchService;

    /**
     * Main endpoint: Get all BTR data for a specific zone with optional filtering
     * Example: GET /api/v1/btr/zone/1/data
     * Example: GET /api/v1/btr/zone/1/data?filter=agricultural
     */
    ...
    /**
     * Get multiple BTR records by IDs
     * Example: GET /api/v1/btr/data/bulk?ids=1,2,3,4,5
     */
    @GetMapping("/data/bulk")
    public ResponseEntity<List<BtrDataResponse>> getBtrDataByIds(
    ...
    /**
     * Check if BTR record exists by ID
     * Example: GET /api/v1/btr/data/123/exists
     */
    ...
    /**
     * Get BTR record with zone validation
     * Example: GET /api/v1/btr/zone/1/data/123
     */
     ...
     * Example: GET /api/v1/btr/zone/1/summary
     */
    ...
    /**
     * Get unique land types for a zone with their counts
     * Example: GET /api/v1/btr/zone/1/land-types
     */
     ...
     * Example: GET /api/v1/btr/zone/1/local-bodies
     */
    ...
    /**
     * Test endpoint to check zone mapping
     * Example: GET /api/v1/btr/zone/1/test
     */
    ...
    public ResponseEntity<String> testZoneMapping(@PathVariable Integer zoneId) {
        try {
            ...
            String message = String.format("Zone %d test successful! Found %d BTR records.",
                    zoneId, data.size());
    ...
    /**
     * Get records count for a zone (quick stats)
     * Example: GET /api/v1/btr/zone/1/count
     */
