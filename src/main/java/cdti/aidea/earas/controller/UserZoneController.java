...
public class UserZoneController {
  ...
  public ResponseEntity<Response> ZoneAssignedService(
      @RequestBody @Valid ZoneAssignedRequset zoneAssignedRequest) {
    try {
      UserZoneAssignment zoneListResponse = zoneService.ZoneAssignedService(zoneAssignedRequest);
      ZoneListResponse userRegistrationResponse = ZoneListResponse.builder().build();
  ...
  @PostMapping("/zone-assignment/update-status")
  public ResponseEntity<Response> updateZoneStatus(@RequestBody @Valid ZoneAssignedRequset request) {
    try {
      UserZoneAssignment updatedAssignment = zoneService.updateZoneAssignmentStatus(request);
