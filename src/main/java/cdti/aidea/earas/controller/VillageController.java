...
public class VillageController {
  ...
  @Autowired private VillageService villageService;
  ...
  public ResponseEntity<List<VillageResponseDTO>> getVillagesByZoneAndLocalBody(
      @PathVariable Integer zoneId, @PathVariable Integer localBodyId) {

    List<VillageResponseDTO> villages =
        villageService.getVillagesByZoneAndLocalBody(zoneId, localBodyId);
