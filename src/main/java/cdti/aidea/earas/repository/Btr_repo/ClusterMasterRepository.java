...
ORDER BY cm.clusterNumber
""")
  List<ClusterSummaryProjection> findClusterSummary(@Param("zoneId") Integer zoneId, @Param("startYear") Integer startYear,
...
""")
  ...
  //ClusterDetails needs to include interconect with form1
  @Query("""
