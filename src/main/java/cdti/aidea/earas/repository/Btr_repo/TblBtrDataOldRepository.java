...
public interface TblBtrDataOldRepository extends JpaRepository<TblBtrDataOld, Long> {
  ...
  Optional<TblBtrDataOld> findByLbcodeAndResvnoAndResbdnoAndLtype(
      String lbcode, Integer resvno, Integer resbdno, String ltype);
  ...
  //    List<TblBtrDataOld> findByLsgcodeAndBcodeAndLtype(Integer lsgcode, String bcode, String
  // ltype);

  // Find all by lsgcode, bcode, ltype and resvno
  List<TblBtrDataOld> findByLsgcodeAndBcodeAndLtypeAndResvno(
      Integer lsgcode, String bcode, String ltype, Integer resvno);

  // Find the range
  List<TblBtrDataOld> findByLsgcodeAndBcodeAndLtypeAndResvnoBetween(
      Integer lsgcode, String bcode, String ltype, Integer start, Integer end);

  List<TblBtrDataOld> findByLsgcodeAndBcodeAndResvnoBetween(
  ...
  //            "CONCAT(CAST(b.resvno AS string), '/', CAST(b.resbdno AS string)) LIKE CONCAT('%',
  // :filter, '%')" +
  //            ")")
