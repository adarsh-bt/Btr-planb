...
public CcePlotResult getAssignedCcePlotsByZoneId(Long zoneId,String agriYear) {
    ...
    return clusters.stream()
            ...
            .map(cluster -> {
              ...
              return FetchDistrictResponse.builder()
                      ...
                      .districtId(district.getDistId())
                      .districtName(district.getDistNameEn())
                      .build();
            })
            .toList();
  }
  ...
  //to interconect with form1
  public List<FormClusterDetailsResponse> getClusterLocalBodyDetails(
          List<Long> clusterIds) {
      System.out.println("Cluster IDs : " + clusterIds);
      return clusterMasterRepository.findClusterLocalBodyDetails(clusterIds);
  }
