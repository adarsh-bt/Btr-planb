...
public class CropAssignmentTrailService {
  ...
  //              "Crop has already been rejected by this user for this cluster");
  //        }
  //      }
  //
  //      // Build the entity
  ...
  //      log.info("Successfully saved crop assignment trail locally with ID: {}",
  // savedTrail.getId());
  //
  ...
  //        log.info("Successfully synced with external service for crop ID: {}",
  // saveDto.getCropId());
  //
  //      } catch (FeignException.BadRequest e) {
  //        log.error(
  //            "Bad request to external service for crop ID {}: Status: {}, Body: {}",
  //            saveDto.getCropId(),
  //            e.status(),
  //            e.contentUTF8());
  ...
  //        log.error(
  //            "Internal server error in external service for crop ID {}: Status: {}, Body: {}",
  //            saveDto.getCropId(),
  //            e.status(),
  //            e.contentUTF8());
  //        throw new RuntimeException(
  //            "External service internal error occurred. Details: " + e.contentUTF8());
  //
  //      } catch (FeignException e) {
  //        log.error(
  //            "Feign client error for crop ID {}: Status: {}, Message: {}, Body: {}",
  //            saveDto.getCropId(),
  //            e.status(),
  //            e.getMessage(),
  //            e.contentUTF8());
  ...
  //      } catch (Exception e) {
  //        log.error(
  //            "Unexpected error during external service sync for crop ID {}: {}",
  //            saveDto.getCropId(),
  //            e.getMessage());
  //        throw new RuntimeException(
  //            "Unexpected error during external service synchronization: " + e.getMessage());
  //      }
  //
  ...
  //    } catch (Exception e) {
  //      log.error(
  //          "Error saving crop assignment trail for crop ID {}: {}",
  //          saveDto.getCropId(),
  //          e.getMessage());
  ...
  //  private CceAssignmentRequest mapToCceAssignmentRequest(
  //      CropAssignmentTrailSaveDto saveDto, KeyPlots keyPlot) {
